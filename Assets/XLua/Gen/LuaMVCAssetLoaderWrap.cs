...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaMVCAssetLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "CreatFile", _m_CreatFile_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CreatFile_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaMVC.AssetLoader.CreatFile( filePath, bytes );

...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp2(PureMVC.Patterns.INotification p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new PureMVC.Patterns.HandleNotification(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(PureMVC.Patterns.HandleModle))
			{
			    return new PureMVC.Patterns.HandleModle(__Gen_Delegate_Imp3);
			}

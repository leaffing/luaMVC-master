...
namespace LuaMVC
{
    ...
    {
        public const string AppName = "LuaMVC";
        // 如果是开发将这个选项设置为true，如果是发布版本设置为false 框架内部会自动划分不同的API
        public const bool IsDeveloping = false;
        ...
        public const string StaticFileServerPath = "http://192.168.38.25:8088/StreamingAssets/LuaMVC/";

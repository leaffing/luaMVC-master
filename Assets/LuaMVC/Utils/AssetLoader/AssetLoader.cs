...
namespace LuaMVC
{
    ...
    public class AssetLoader : MonoBehaviour
    {
        ...
        private static string m_assetServerPath = "http://192.168.38.25:8088/StreamingAssets/LuaMVC/Data/"; // 服务器资源文件夹路径 todo 这个值应该由服务器传递到客户端
        ...
        static IEnumerator CheckExtractResource()
        {
            ...
            {
                print("文件已经解压过");
                yield break;   //文件已经解压过了，自己可添加检查文件列表逻辑
            }
        ...
        {
            string dataPath = FilePath.DataPath;  //数据目录
            string resPath = FilePath.AppContentPath(); //游戏包资源目录
